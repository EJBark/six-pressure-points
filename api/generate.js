...
function buildPrompt(r) {
  return `You are an expert organisational diagnostician working within the Six Pressure Points framework — a diagnostic tool that assesses how well an organisation is set up to do what it's supposed to do.

The Six Pressure Points are:
1. Direction — Does the organisation know where it's going?
...
5. Delivery — Is work actually getting done, and do they know why when it isn't?
