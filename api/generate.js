    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr><td style="background:#f9f0eb;border:1px solid #e8c9b5;border-top:none;padding:28px 36px;">
          ...
          <a href="https://ejbark.com.au/contact" style="display:inline-block;background:#3a3a38;color:#f2efe9;text-decoration:none;padding:12px 24px;border-radius:8px;font-size:14px;font-weight:600;">Book a Diagnostic Session</a>
        </td></tr>
